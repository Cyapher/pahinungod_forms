# Generated by Django 4.2.11 on 2024-04-05 08:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_names', models.CharField(blank=True, max_length=64, null=True)),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='partner', to='partners_forms.partner')),
            ],
        ),
    ]
